...
(function (window, factory) {
  ...
  var mapToolUrls = {
    EventWrapper: {
      js: 'http://api.map.baidu.com/library/EventWrapper/1.2/src/EventWrapper.min.js'
    },
    SearchInRectangle: {
      js: 'http://api.map.baidu.com/library/SearchInRectangle/1.2/src/SearchInRectangle_min.js'
    },
    DrawingManager: {
    ...
    GeoUtils: {
      js: 'http://api.map.baidu.com/library/GeoUtils/1.2/src/GeoUtils_min.js'
    },
    DistanceTool: {
    ...
    MarkerClusterer: {
      js: 'http://api.map.baidu.com/library/MarkerClusterer/1.2/src/MarkerClusterer_min.js'
    },
    CityList: {
      js: 'http://api.map.baidu.com/library/CityList/1.4/src/CityList_min.js'
    },
    TrafficControl: {
      css: 'http://api.map.baidu.com/library/TrafficControl/1.4/src/TrafficControl_min.css',
      js: 'http://api.map.baidu.com/library/TrafficControl/1.4/src/TrafficControl_min.js'
    },
    SearchInfoWindow: {
      css: 'http://api.map.baidu.com/library/SearchInfoWindow/1.5/src/SearchInfoWindow_min.css',
      js: 'http://api.map.baidu.com/library/SearchInfoWindow/1.5/src/SearchInfoWindow_min.js'
    },
    InfoBox: {
      js: 'http://api.map.baidu.com/library/InfoBox/1.2/src/InfoBox_min.js'
    },
    MarkerManager: {
      js: 'http://api.map.baidu.com/library/MarkerManager/1.2/src/MarkerManager_min.js'
    }
  }
  ...
  var TMap = function (options) {
    ...
    if (!window.isMap) {
      if (_this.config.mapType == 1) {
        ...
        var script = document.createElement('script');
        script.src = 'http://api.map.baidu.com/getscript?v=2.0&ak=' + _this.config.ak + '&services=&t=20171031174121';
        document.body.appendChild(script);
      } else if (_this.config.mapType == 2) {
        var script = document.createElement('script');
        script.src = 'http://webapi.amap.com/maps?v=1.4.1&key=' + _this.config.ak + '';
